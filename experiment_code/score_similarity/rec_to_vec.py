...
class RecToVec:
    ...
    def __init__(self, graph,
        ...
        for foodkg_food in graph.subjects(predicate=rdflib.URIRef('http://www.w3.org/2002/07/owl#equivalentClass'), object=None): #predicate=rdflib.namespace.RDF['type'], object=food_ns['ingredientname']):
